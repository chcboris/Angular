...
export class ServidorService {
  ...
  // acionando um get retornando um jason por id
  consultarPorId(codigo: string): Observable<Visitante> {
    return this.http.get<Visitante>(this.url + '/testarObterVisitante/' + codigo);
  }
